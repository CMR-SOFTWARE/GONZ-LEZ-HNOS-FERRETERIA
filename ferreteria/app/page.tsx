...
export default function HomePage() {
  ...
  return (
    <div className="w-full min-w-0">
      ...
      {/* Hero banner */}
      <div className="rounded-xl bg-orange-600 px-3 py-2 shadow-md shadow-orange-600/20 sm:px-4 sm:py-2.5 mb-4 sm:mb-5 text-white">
        <div className="flex flex-col gap-1.5 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
          <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
            <div className="relative h-9 w-9 shrink-0 overflow-hidden rounded-md border border-white/30 bg-white/95 p-0.5 sm:h-10 sm:w-10">
              <Image
          ...
          <a
            ...
            className="inline-flex shrink-0 items-center justify-center gap-1.5 bg-green-500 hover:bg-green-600 text-white font-semibold px-3 py-1.5 rounded-md text-xs transition-colors sm:self-center"
          >
